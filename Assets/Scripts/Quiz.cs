...
public class QuizManager : MonoBehaviour
{
    ...
    // Define the questions and their corresponding correct answers
    private List<string> questions = new List<string>
    {
        ...
        "What does the Psyche Radio Science measure?",
        "What is the purpose of Deep Space Optical Communication (DSOC)?",
        "How big is the Psyche spacecraft bus (body)?",
        "Who provides launch services for the Psyche mission?",
        "What type of propulsion does the Psyche spacecraft use?",
        "What is the Psyche spacecraft's estimated travel distance to Psyche?",
        "How long will the Psyche mission travel from launch to the end of the primary mission?",
        "What institution is responsible for the Psyche DSOC technology?",
    ...
    private List<List<string>> options = new List<List<string>>
    {
        ...
        new List<string> { "Human mission", "Space telescope mission", "NASA’s Discovery Program mission", "Mars mission" },
        new List<string> { "Weather patterns", "Composition of gas giants", "Earth’s core formation", "History of comets" },
        ...
        new List<string> { "Only through newspapers", "Visit psyche.asu.edu", "Watch TV documentaries", "Ask your teacher" },
        ...
        new List<string> { "1,000 kg/m3", "2,500 kg/m3", "3,400–4,100 kg/m3", "5,000 kg/m3" },
        new List<string> { "No", "Yes, similar to Earth", "Yes, but less than Earth", "Yes, more than Earth" },
        ...
        new List<string> { "Rocket boosters", "Solarelectric propulsion", "Nuclear propulsion", "Ion thrusters" },
        ...
        new List<string> { "Fixed orbit", "Circular orbit", "From four staging", "Varied orbit" },
        new List<string> { "A, B, C, D", "Alpha, Beta, Gamma, Delta", "First, Second, Third, Fourth", "One, Two, Three, Four" },
        ...
        new List<string> { "MIT", "ASU", "Arizona State University", "SpaceX" },
        ...
        new List<string> { "Chemical propulsion", "Solarelectric propulsion", "Nuclear propulsion", "Ion propulsion" },
        new List<string> { "1 billion miles", "~1.5 billion miles", "2 billion miles", "3 billion miles" },
        ...
        new List<string> { "Elon Musk", "ASU President", "NASA Administrator", "[Need to check Psyche Team Page for correct answer]" },
        ...
        new List<string> { "NASA’s official website", "Psyche Mission's Twitter account", "[Need to check Psyche Team Page for correct answer]", "Your school's library" },
    };
